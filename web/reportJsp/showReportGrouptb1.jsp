...
<%
    ...
    String url1 = "reportJsp/showReportGrouptb.jsp?rpg=/ganBuTongJi/ganBuTongJi_zx/zxGroup.rpg&tjDate="+tjDate+"&startDate="+startDate+"&endDate="+endDate+"&userID="+userID+"&col="+col;
...
<!--<td><button onclick="save2()" id="sbBtn">上报</button></td>-->
<td><button onclick="save3()"id="Btn">抽数</button></td>
<!--<td><button onclick="zq()"id="Btn">反显</button></td>-->
...
//上报入库修改状态值为2
 ...
 function save3() {
	 ...
	 var tjDate="<%=tjDate%>";
		...
		if(cell1 != null){
			...
			if (E1=='2'||E1=='0')
			{
                   window.open("showReportGrouptbcs_sb.jsp?rpg=/ganBuTongJi/ganBuTongJi_or/orGroup.rpg&tjDate="+tjDate+"&startDate="+startDate+"&endDate="+endDate+"&userID="+userID+"&col="+col,"_self");
			}
           else{
			   window.open("showReportGrouptbcs.jsp?rpg=/ganBuTongJi/ganBuTongJi_or/orGroup.rpg&tjDate="+tjDate+"&startDate="+startDate+"&endDate="+endDate+"&userID="+userID+"&col="+col,"_self");
			   }
 ...
 function zq() {
 	...
 	window.open("showReportGroup_olzq.jsp?rpg=/ganBuTongJi/ganBuTongJi_tbzq/tbzqGroup.rpg&tjDate="+tjDate+"&startDate="+startDate+"&endDate="+endDate+"&userID="+userID+"&col="+col,"_self");
