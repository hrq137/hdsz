...
<!--<td><button onclick="save3()"id="Btn">获取数据</button></td>
...
//上报入库修改状态值为2
 ...
 function save3() {
 	...
 	window.open("showReportGroup_oltb.jsp?rpg=/ganBuTongJi/ganBuTongJi_or/orGroup.rpg&tjDate="+tjDate+"&startDate="+startDate+"&endDate="+endDate+"&userID="+userID+"&col="+col,"_self");
