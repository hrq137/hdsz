...
<%
	...
	String url1 = "http://127.0.0.1:6001/demo/reportJsp/test1.jsp?rpg=/shlb_test.raq&tjDate="+tjDate+"&tableName=干部统计表"+"&userID="+userID;
...
%>
<iframe src="" id="m1" name='m1' width=250 height=40 scrolling="no" ></iframe><br>
...
//alert(userID);
//alert(tjDate);
parent.document.getElementById("m1").src="test1.jsp?raq=/shlb_test1.raq&tjDate="+tjDate+"&tableName=干部统计表"+"&userID="+userID;
