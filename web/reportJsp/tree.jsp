...
function showReport(menuID)
{
    ...
    parent.contentArea.location.href="<%=request.getContextPath()%>/reportJsp/showReport.jsp?raq="+selectRPTObj.getAttribute( "reportFile" );
}
function showReportGroup(menuID)
{
	...
	selectImgObj = eval(menuID + "IMG");
	selectRPTObj.style.color="#FF0000";
    parent.contentArea.location.href="<%=request.getContextPath()%>/reportJsp/showReportGroup.jsp?rpg="+selectRPTObj.getAttribute( "reportFile" );
}
function showJsp(menuID)
{
	...
	selectImgObj = eval(menuID + "IMG");
	selectRPTObj.style.color="#FF0000";
    parent.contentArea.location.href="<%=request.getContextPath()%>/jsp"+selectRPTObj.getAttribute( "reportFile" );
}
</script>
