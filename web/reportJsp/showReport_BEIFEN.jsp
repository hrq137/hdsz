...
function forDatell(tjDate,userID,startDate,endDate,col,tab) {
		...
		window.location.href = "http://"+window.location.host+"/report/"+"reportJsp/showReportGrouptb.jsp?rpg=/ganBuTongJi/ganBuTongJi_zx/zxGroup.rpg&tjDate="+
			tjDate+"&userID="+userID+"&startDate="+startDate+"&endDate="+endDate+"&col="+col+"&tab="+tab ;
	}

	function forDatell_lujuhz(tjDate,userID,userid,tab) {
		var index = layer.load();
		window.location.href = "http://"+window.location.host+"/report/"+"reportJsp/showReportGrouptb_luju.jsp?rpg=/ganBuTongJi/ganBuTongJi_hz/hzGroup.rpg&tjDate="+
			tjDate+"&userID="+userID+"&userid="+userid+"&tab="+tab ;
	}

	function forDatell_lujuzx(tjDate,userID,tab) {
		var index = layer.load();
		window.location.href = "http://"+window.location.host+"/report/"+"reportJsp/showReportGrouptb_luju.jsp?rpg=/ganBuTongJi/ganBuTongJi_zx/zxGroup.rpg&tjDate="+
			tjDate+"&userID="+userID+"&tab="+tab ;
	}

  //总公司的归档跳转链接
   //状态值为null跳转的链接
    function forDatell_hztb(tjDate,userID,userid,tab) {
    var index = layer.load();
  ...
  //状态值5跳转的链接
  function forDatell_fr(tjDate,userID,tab) {
    var index = layer.load();
  window.location.href = "http://"+window.location.host+"/report/"+"reportJsp/showReportGroup_fr.jsp?rpg=/ganBuTongJi/ganBuTongJi_zx/zxGroup.rpg&tjDate="+tjDate+"&userID="+userID+"&tab="+tab ;
  }
   //状态值9跳转的链接
  function forDatell_ck(tjDate,userID,tab) {
    var index = layer.load();
